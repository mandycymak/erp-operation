...
**Latest session (2026-06-23b — third-party Find API: JWT bearer auth + server-side natural-language `/api-ops/find-text` + name->code resolution (places/carriers/companies) + a browser chat tester. RESUME HERE).**
