...
**Latest session (2026-06-26d — Generate Document from the ERP (drawer-triggered) + an Admin documentTypeCode/houseTypeCode config. Verified the live /document/generate behavior on demoerp. RESUME HERE).**
