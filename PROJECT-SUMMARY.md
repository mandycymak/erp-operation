...
**Latest session (2026-06-25b — data freshness: delta/watermark worklist pull so the refresh runs every few minutes cheaply (Air ~5 min / Sea ~15 min), plus a new-booking -> factory(shipper) alert watcher. RESUME HERE).**
