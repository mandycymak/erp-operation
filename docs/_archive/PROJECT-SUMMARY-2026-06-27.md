...
[8-API.md](docs/8-API.md) (third-party Find API). This file remains the
...
- **Verified Air field map** (see [docs/7-SQL-REFERENCE.md](docs/7-SQL-REFERENCE.md) §4): Airport of Destination =
